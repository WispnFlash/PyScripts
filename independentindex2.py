...
directory1 = directory0 + "Data/Indexes/Independent/" + treatment1
directory2 = directory0 + "Data/Indexes/Independent/" + treatment2
directory3 = directory0 + "Data/Indexes/Independent/" + treatment3
directory4 = directory0 + "Data/Indexes/Independent/" + treatment4
directory5 = directory0 + "Data/Indexes/Independent/" + treatment5
directory6 = directory0 + "Data/Indexes/Independent/" + treatment6
directory7 = directory0 + "Data/Indexes/Independent/" + treatment7
directory8 = directory0 + "Data/Indexes/Independent/" + treatment8
directory9 = directory0 + "Data/Indexes/Independent/" + treatment9
directory10 = directory0 + "Data/Indexes/Independent/" + treatment10
directory11 = directory0 + "Data/Indexes/Independent/" + treatment11
directory12 = directory0 + "Data/Indexes/Independent/" + treatment12
...
def CriterionReached(groupdataset):
	...
	for element in range(0, 89):
		temp = inputarray["LearningIndex"][(inputarray["Hour"] == indexer)]
	...
	Index.columns = ["Hour", "LearningIndex", "Error"]
...
if (numberofgroups == 1):
	...
	plt.plot(Group1["Hour"], Group1["LearningIndex"], Color=Color1, marker=",", linestyle="-")
	plotline1, caplines1, line1 = plt.errorbar(Group1["Hour"], Group1["LearningIndex"], yerr=Group1["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
	caplines1[0].set_marker('_')
	caplines1[0].set_markersize(3)
	plt.title("Independent Learning Index by Hour", fontsize=20)
	plt.xlabel("Hour", fontsize=16)
	plt.ylabel("Independent Index", fontsize=16)
	...
	plt.savefig(directory0 + "Graphs/LearningIndex" + today + ".jpg")
...
if (numberofgroups == 2):
	...
	if (value == 1):
		...
		plt.plot(Group2["Hour"], Group2["LearningIndex"], Color=Color2, marker=",", linestyle="-")
		plotline2, caplines2, line2 = plt.errorbar(Group2["Hour"], Group2["LearningIndex"], yerr=Group2["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 3):
	...
	if (value == 1):
		...
		plt.plot(Group3["Hour"], Group3["LearningIndex"], Color=Color3, marker=",", linestyle="-")
		plotline3, caplines3, line3 = plt.errorbar(Group3["Hour"], Group3["LearningIndex"], yerr=Group3["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 4):
	...
	if (value == 1):
		...
		plt.plot(Group4["Hour"], Group4["LearningIndex"], Color=Color4, marker=",", linestyle="-")
		plotline4, caplines4, line4 = plt.errorbar(Group4["Hour"], Group4["LearningIndex"], yerr=Group4["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 5):
	...
	if (value == 1):
		...
		plt.plot(Group5["Hour"], Group5["LearningIndex"], Color=Color5, marker=",", linestyle="-")
		plotline5, caplines5, line5 = plt.errorbar(Group5["Hour"], Group5["LearningIndex"], yerr=Group5["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 6):
	...
	if (value == 1):
		...
		plt.plot(Group6["Hour"], Group6["LearningIndex"], Color=Color6, marker=",", linestyle="-")
		plotline6, caplines6, line6 = plt.errorbar(Group6["Hour"], Group6["LearningIndex"], yerr=Group6["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 7):
	...
	if (value == 1):
		...
		plt.plot(Group7["Hour"], Group7["LearningIndex"], Color=Color7, marker=",", linestyle="-")
		plotline7, caplines7, line7 = plt.errorbar(Group7["Hour"], Group7["LearningIndex"], yerr=Group7["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 8):
	...
	if (value == 1):
		...
		plt.plot(Group8["Hour"], Group8["LearningIndex"], Color=Color8, marker=",", linestyle="-")
		plotline8, caplines8, line8 = plt.errorbar(Group8["Hour"], Group8["LearningIndex"], yerr=Group8["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 9):
	...
	if (value == 1):
		...
		plt.plot(Group9["Hour"], Group9["LearningIndex"], Color=Color9, marker=",", linestyle="-")
		plotline9, caplines9, line9 = plt.errorbar(Group9["Hour"], Group9["LearningIndex"], yerr=Group9["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 10):
	...
	if (value == 1):
		...
		plt.plot(Group10["Hour"], Group10["LearningIndex"], Color=Color10, marker=",", linestyle="-")
		plotline10, caplines10, line10 = plt.errorbar(Group10["Hour"], Group10["LearningIndex"], yerr=Group10["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 11):
	...
	if (value == 1):
		...
		plt.plot(Group11["Hour"], Group11["LearningIndex"], Color=Color11, marker=",", linestyle="-")
		plotline11, caplines11, line11 = plt.errorbar(Group11["Hour"], Group11["LearningIndex"], yerr=Group11["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 12):
	...
	if (value == 1):
		...
		plt.plot(Group12["Hour"], Group12["LearningIndex"], Color=Color12, marker=",", linestyle="-")
		plotline12, caplines12, line12 = plt.errorbar(Group12["Hour"], Group12["LearningIndex"], yerr=Group12["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
