...
directory2 = directory0 + "Data/Reversal/" + treatment2
directory3 = directory0 + "Data/Reversal/" + treatment3
directory4 = directory0 + "Data/Reversal/" + treatment4
directory5 = directory0 + "Data/Reversal/" + treatment5
directory6 = directory0 + "Data/Reversal/" + treatment6
directory7 = directory0 + "Data/Reversal/" + treatment7
directory8 = directory0 + "Data/Reversal/" + treatment8
directory9 = directory0 + "Data/Reversal/" + treatment9
directory10 = directory0 + "Data/Reversal/" + treatment10
directory11 = directory0 + "Data/Reversal/" + treatment11
directory12 = directory0 + "Data/Reversal/" + treatment12
...
if (numberofgroups == 1):
	...
	if (value == 1):
		...
		Group1 = pd.read_csv(maindirectory + "Temp/" + treatment1 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
			plt.title("Reversal 70% criterion", fontsize=20)
		if (criterion == 80):
			plt.plot(Group1["Entry"][0:2000], Group1["Eighty"][0:2000], Color=Color1)
			plt.title("Reversal 80% criterion", fontsize=20)
		if (criterion == 90):
			plt.plot(Group1["Entry"][0:2000], Group1["Ninety"][0:2000], Color=Color1)
			plt.title("Reversal 90% criterion", fontsize=20)
		...
		plt.savefig(directory0 + "Graphs/ReversalSurvival" + today + ".jpg")
		plt.show()	
...
if (numberofgroups == 2):
	...
	if (value == 1):
		...
		Group1 = pd.read_csv(maindirectory + "Temp/" + treatment1 + "ReversalSurvival.csv")
		Group2 = pd.read_csv(maindirectory + "Temp/" + treatment2 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
...
if (numberofgroups == 3):
	...
	if (value == 1):
		...
		Group1 = pd.read_csv(maindirectory + "Temp/" + treatment1 + "ReversalSurvival.csv")
		Group2 = pd.read_csv(maindirectory + "Temp/" + treatment2 + "ReversalSurvival.csv")
		Group3 = pd.read_csv(maindirectory + "Temp/" + treatment3 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
			plt.plot(Group2["Entry"][0:2000], Group2["Seventy"][0:2000], Color=Color2)
...
if (numberofgroups == 4):
	...
	if (value == 1):
		...
		Group2 = pd.read_csv(maindirectory + "Temp/" + treatment2 + "ReversalSurvival.csv")
		Group3 = pd.read_csv(maindirectory + "Temp/" + treatment3 + "ReversalSurvival.csv")
		Group4 = pd.read_csv(maindirectory + "Temp/" + treatment4 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
			plt.plot(Group2["Entry"][0:2000], Group2["Seventy"][0:2000], Color=Color2)
			plt.plot(Group3["Entry"][0:2000], Group3["Seventy"][0:2000], Color=Color3)
...
if (numberofgroups == 5):
	...
	if (value == 1):
		...
		Group3 = pd.read_csv(maindirectory + "Temp/" + treatment3 + "ReversalSurvival.csv")
		Group4 = pd.read_csv(maindirectory + "Temp/" + treatment4 + "ReversalSurvival.csv")
		Group5 = pd.read_csv(maindirectory + "Temp/" + treatment5 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
			plt.plot(Group2["Entry"][0:2000], Group2["Seventy"][0:2000], Color=Color2)
			plt.plot(Group3["Entry"][0:2000], Group3["Seventy"][0:2000], Color=Color3)
...
if (numberofgroups == 6):
	...
	if (value == 1):
		...
		Group4 = pd.read_csv(maindirectory + "Temp/" + treatment4 + "ReversalSurvival.csv")
		Group5 = pd.read_csv(maindirectory + "Temp/" + treatment5 + "ReversalSurvival.csv")
		Group6 = pd.read_csv(maindirectory + "Temp/" + treatment6 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
			plt.plot(Group2["Entry"][0:2000], Group2["Seventy"][0:2000], Color=Color2)
			plt.plot(Group3["Entry"][0:2000], Group3["Seventy"][0:2000], Color=Color3)
...
if (numberofgroups == 7):
	...
	if (value == 1):
		...
		Group5 = pd.read_csv(maindirectory + "Temp/" + treatment5 + "ReversalSurvival.csv")
		Group6 = pd.read_csv(maindirectory + "Temp/" + treatment6 + "ReversalSurvival.csv")
		Group7 = pd.read_csv(maindirectory + "Temp/" + treatment7 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
			plt.plot(Group2["Entry"][0:2000], Group2["Seventy"][0:2000], Color=Color2)
			plt.plot(Group3["Entry"][0:2000], Group3["Seventy"][0:2000], Color=Color3)
...
if (numberofgroups == 8):
	...
	if (value == 1):
		...
		Group6 = pd.read_csv(maindirectory + "Temp/" + treatment6 + "ReversalSurvival.csv")
		Group7 = pd.read_csv(maindirectory + "Temp/" + treatment7 + "ReversalSurvival.csv")
		Group8 = pd.read_csv(maindirectory + "Temp/" + treatment8 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
			plt.plot(Group2["Entry"][0:2000], Group2["Seventy"][0:2000], Color=Color2)
			plt.plot(Group3["Entry"][0:2000], Group3["Seventy"][0:2000], Color=Color3)
...
if (numberofgroups == 9):
	...
	if (value == 1):
		...
		Group7 = pd.read_csv(maindirectory + "Temp/" + treatment7 + "ReversalSurvival.csv")
		Group8 = pd.read_csv(maindirectory + "Temp/" + treatment8 + "ReversalSurvival.csv")
		Group9 = pd.read_csv(maindirectory + "Temp/" + treatment9 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
			plt.plot(Group2["Entry"][0:2000], Group2["Seventy"][0:2000], Color=Color2)
			plt.plot(Group3["Entry"][0:2000], Group3["Seventy"][0:2000], Color=Color3)
...
if (numberofgroups == 10):
	...
	if (value == 1):
		...
		Group8 = pd.read_csv(maindirectory + "Temp/" + treatment8 + "ReversalSurvival.csv")
		Group9 = pd.read_csv(maindirectory + "Temp/" + treatment9 + "ReversalSurvival.csv")
		Group10 = pd.read_csv(maindirectory + "Temp/" + treatment10 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
			plt.plot(Group2["Entry"][0:2000], Group2["Seventy"][0:2000], Color=Color2)
			plt.plot(Group3["Entry"][0:2000], Group3["Seventy"][0:2000], Color=Color3)
...
if (numberofgroups == 11):
	...
	if (value == 1):
		...
		Group9 = pd.read_csv(maindirectory + "Temp/" + treatment9 + "ReversalSurvival.csv")
		Group10 = pd.read_csv(maindirectory + "Temp/" + treatment10 + "ReversalSurvival.csv")
		Group11 = pd.read_csv(maindirectory + "Temp/" + treatment11 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
			plt.plot(Group2["Entry"][0:2000], Group2["Seventy"][0:2000], Color=Color2)
			plt.plot(Group3["Entry"][0:2000], Group3["Seventy"][0:2000], Color=Color3)
...
if (numberofgroups == 12):
	...
	if (value == 1):
		...
		Group10 = pd.read_csv(maindirectory + "Temp/" + treatment10 + "ReversalSurvival.csv")
		Group11 = pd.read_csv(maindirectory + "Temp/" + treatment11 + "ReversalSurvival.csv")
		Group12 = pd.read_csv(maindirectory + "Temp/" + treatment12 + "ReversalSurvival.csv")
		if (criterion == 70):
			plt.plot(Group1["Entry"][0:2000], Group1["Seventy"][0:2000], Color=Color1)
			plt.plot(Group2["Entry"][0:2000], Group2["Seventy"][0:2000], Color=Color2)
			plt.plot(Group3["Entry"][0:2000], Group3["Seventy"][0:2000], Color=Color3)
