...
directory1 = directory0 + "Data/Feeding/" + treatment1
directory2 = directory0 + "Data/Feeding/" + treatment2
directory3 = directory0 + "Data/Feeding/" + treatment3
directory4 = directory0 + "Data/Feeding/" + treatment4
directory5 = directory0 + "Data/Feeding/" + treatment5
directory6 = directory0 + "Data/Feeding/" + treatment6
directory7 = directory0 + "Data/Feeding/" + treatment7
directory8 = directory0 + "Data/Feeding/" + treatment8
directory9 = directory0 + "Data/Feeding/" + treatment9
directory10 = directory0 + "Data/Feeding/" + treatment10
directory11 = directory0 + "Data/Feeding/" + treatment11
directory12 = directory0 + "Data/Feeding/" + treatment12
...
def CriterionReached(groupdataset):
	...
	FeedingMeans = np.zeros(89)
	FeedingErrors = np.zeros(89)
	Hour = np.array(range(1, 90))
	Hour = pd.DataFrame(Hour)
	indexer = 1
	for element in range(0, 89):
		temp = inputarray["TotFeeding"][(inputarray["Hour"] == indexer)]
		FeedingMeans[element] = temp.mean()
		FeedingErrors[element] = stats.sem(temp)
		indexer = indexer + 1
		del temp
	FeedingMeans = pd.DataFrame(FeedingMeans)
	FeedingErrors = pd.DataFrame(FeedingErrors)
	Feeding = pd.concat([Hour, FeedingMeans, FeedingErrors], axis = 1)
	Feeding.columns = ["Hour", "TotFeeding", "Error"]
	Feeding.to_csv("G:/Behavioral Data/Sonntag Lab Dropbox/Phenotyper/Investigators/Temp/" + treatment + "feeding.csv")
	return Feeding
...
if (numberofgroups == 1):
	...
	Group1 = pd.read_csv(maindirectory + "Temp/" + treatment1 + "feeding.csv")
	plt.plot(Group1["Hour"], Group1["TotFeeding"], Color=Color1, marker=",", linestyle="-")
	plotline1, caplines1, line1 = plt.errorbar(Group1["Hour"], Group1["TotFeeding"], yerr=Group1["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
	caplines1[0].set_marker('_')
	caplines1[0].set_markersize(3)
	plt.title("Feeding by Hour", fontsize=20)
	plt.xlabel("Hour", fontsize=16)
	plt.ylabel("pellet rewards", fontsize=16)
	...
	plt.savefig(directory0 + "Graphs/TotFeeding" + today + ".jpg")
...
if (numberofgroups == 2):
	...
	if (value == 1):
		...
		Group1 = pd.read_csv(maindirectory + "Temp/" + treatment1 + "feeding.csv")
		Group2 = pd.read_csv(maindirectory + "Temp/" + treatment2 + "feeding.csv")
		...
		plt.plot(Group2["Hour"], Group2["TotFeeding"], Color=Color2, marker=",", linestyle="-")
		plotline2, caplines2, line2 = plt.errorbar(Group2["Hour"], Group2["TotFeeding"], yerr=Group2["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 3):
	...
	if (value == 1):
		...
		Group1 = pd.read_csv(maindirectory + "Temp/" + treatment1 + "feeding.csv")
		Group2 = pd.read_csv(maindirectory + "Temp/" + treatment2 + "feeding.csv")
		Group3 = pd.read_csv(maindirectory + "Temp/" + treatment3 + "feeding.csv")
		...
		plt.plot(Group3["Hour"], Group3["TotFeeding"], Color=Color3, marker=",", linestyle="-")
		plotline3, caplines3, line3 = plt.errorbar(Group3["Hour"], Group3["TotFeeding"], yerr=Group3["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 4):
	...
	if (value == 1):
		...
		Group2 = pd.read_csv(maindirectory + "Temp/" + treatment2 + "feeding.csv")
		Group3 = pd.read_csv(maindirectory + "Temp/" + treatment3 + "feeding.csv")
		Group4 = pd.read_csv(maindirectory + "Temp/" + treatment4 + "feeding.csv")
		...
		plt.plot(Group4["Hour"], Group4["TotFeeding"], Color=Color4, marker=",", linestyle="-")
		plotline4, caplines4, line4 = plt.errorbar(Group4["Hour"], Group4["TotFeeding"], yerr=Group4["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 5):
	...
	if (value == 1):
		...
		Group3 = pd.read_csv(maindirectory + "Temp/" + treatment3 + "feeding.csv")
		Group4 = pd.read_csv(maindirectory + "Temp/" + treatment4 + "feeding.csv")
		Group5 = pd.read_csv(maindirectory + "Temp/" + treatment5 + "feeding.csv")
		...
		plt.plot(Group5["Hour"], Group5["TotFeeding"], Color=Color5, marker=",", linestyle="-")
		plotline5, caplines5, line5 = plt.errorbar(Group5["Hour"], Group5["TotFeeding"], yerr=Group5["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 6):
	...
	if (value == 1):
		...
		Group4 = pd.read_csv(maindirectory + "Temp/" + treatment4 + "feeding.csv")
		Group5 = pd.read_csv(maindirectory + "Temp/" + treatment5 + "feeding.csv")
		Group6 = pd.read_csv(maindirectory + "Temp/" + treatment6 + "feeding.csv")
		...
		plt.plot(Group6["Hour"], Group6["TotFeeding"], Color=Color6, marker=",", linestyle="-")
		plotline6, caplines6, line6 = plt.errorbar(Group6["Hour"], Group6["TotFeeding"], yerr=Group6["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 7):
	...
	if (value == 1):
		...
		Group5 = pd.read_csv(maindirectory + "Temp/" + treatment5 + "feeding.csv")
		Group6 = pd.read_csv(maindirectory + "Temp/" + treatment6 + "feeding.csv")
		Group7 = pd.read_csv(maindirectory + "Temp/" + treatment7 + "feeding.csv")
		...
		plt.plot(Group7["Hour"], Group7["TotFeeding"], Color=Color7, marker=",", linestyle="-")
		plotline7, caplines7, line7 = plt.errorbar(Group7["Hour"], Group7["TotFeeding"], yerr=Group7["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 8):
	...
	if (value == 1):
		...
		Group6 = pd.read_csv(maindirectory + "Temp/" + treatment6 + "feeding.csv")
		Group7 = pd.read_csv(maindirectory + "Temp/" + treatment7 + "feeding.csv")
		Group8 = pd.read_csv(maindirectory + "Temp/" + treatment8 + "feeding.csv")
		...
		plt.plot(Group8["Hour"], Group8["TotFeeding"], Color=Color8, marker=",", linestyle="-")
		plotline8, caplines8, line8 = plt.errorbar(Group8["Hour"], Group8["TotFeeding"], yerr=Group8["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 9):
	...
	if (value == 1):
		...
		Group7 = pd.read_csv(maindirectory + "Temp/" + treatment7 + "feeding.csv")
		Group8 = pd.read_csv(maindirectory + "Temp/" + treatment8 + "feeding.csv")
		Group9 = pd.read_csv(maindirectory + "Temp/" + treatment9 + "feeding.csv")
		...
		plt.plot(Group9["Hour"], Group9["TotFeeding"], Color=Color9, marker=",", linestyle="-")
		plotline9, caplines9, line9 = plt.errorbar(Group9["Hour"], Group9["TotFeeding"], yerr=Group9["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 10):
	...
	if (value == 1):
		...
		Group8 = pd.read_csv(maindirectory + "Temp/" + treatment8 + "feeding.csv")
		Group9 = pd.read_csv(maindirectory + "Temp/" + treatment9 + "feeding.csv")
		Group10 = pd.read_csv(maindirectory + "Temp/" + treatment10 + "feeding.csv")
		...
		plt.plot(Group10["Hour"], Group10["TotFeeding"], Color=Color10, marker=",", linestyle="-")
		plotline10, caplines10, line10 = plt.errorbar(Group10["Hour"], Group10["TotFeeding"], yerr=Group10["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 11):
	...
	if (value == 1):
		...
		Group9 = pd.read_csv(maindirectory + "Temp/" + treatment9 + "feeding.csv")
		Group10 = pd.read_csv(maindirectory + "Temp/" + treatment10 + "feeding.csv")
		Group11 = pd.read_csv(maindirectory + "Temp/" + treatment11 + "feeding.csv")
		...
		plt.plot(Group11["Hour"], Group11["TotFeeding"], Color=Color11, marker=",", linestyle="-")
		plotline11, caplines11, line11 = plt.errorbar(Group11["Hour"], Group11["TotFeeding"], yerr=Group11["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 12):
	...
	if (value == 1):
		...
		Group10 = pd.read_csv(maindirectory + "Temp/" + treatment10 + "feeding.csv")
		Group11 = pd.read_csv(maindirectory + "Temp/" + treatment11 + "feeding.csv")
		Group12 = pd.read_csv(maindirectory + "Temp/" + treatment12 + "feeding.csv")
		...
		plt.plot(Group12["Hour"], Group12["TotFeeding"], Color=Color12, marker=",", linestyle="-")
		plotline12, caplines12, line12 = plt.errorbar(Group12["Hour"], Group12["TotFeeding"], yerr=Group12["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
