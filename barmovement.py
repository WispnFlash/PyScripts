...
directory1 = directory0 + "Data/Distance moved/" + treatment1
directory2 = directory0 + "Data/Distance moved/" + treatment2
directory3 = directory0 + "Data/Distance moved/" + treatment3
directory4 = directory0 + "Data/Distance moved/" + treatment4
directory5 = directory0 + "Data/Distance moved/" + treatment5
directory6 = directory0 + "Data/Distance moved/" + treatment6
directory7 = directory0 + "Data/Distance moved/" + treatment7
directory8 = directory0 + "Data/Distance moved/" + treatment8
directory9 = directory0 + "Data/Distance moved/" + treatment9
directory10 = directory0 + "Data/Distance moved/" + treatment10
directory11 = directory0 + "Data/Distance moved/" + treatment11
directory12 = directory0 + "Data/Distance moved/" + treatment12
...
def CriterionReached(groupdataset):
	...
	DistanceMeans = np.zeros(89)
	DistanceErrors = np.zeros(89)
	Hour = np.array(range(1, 90))
	Hour = pd.DataFrame(Hour)
	indexer = 1
	for element in range(0, 89):
		temp = inputarray["TotPathlength"][(inputarray["Hour"] == indexer)]
		DistanceMeans[element] = temp.mean()
		DistanceErrors[element] = stats.sem(temp)
		indexer = indexer + 1
		del temp
	DistanceMeans = pd.DataFrame(DistanceMeans)
	DistanceErrors = pd.DataFrame(DistanceErrors)
	Distance = pd.concat([Hour, DistanceMeans, DistanceErrors], axis = 1)
	Distance.columns = ["Hour", "TotPathlength", "Error"]
	Distance.to_csv("G:/Behavioral Data/Sonntag Lab Dropbox/Phenotyper/Investigators/Temp/" + treatment + "distancemoved.csv")
	return Distance
...
if (numberofgroups == 1):
	...
	Group1 = pd.read_csv(maindirectory + "Temp/" + treatment1 + "distancemoved.csv")
	plt.plot(Group1["Hour"], Group1["TotPathlength"], Color=Color1, marker=",", linestyle="-")
	plotline1, caplines1, line1 = plt.errorbar(Group1["Hour"], Group1["TotPathlength"], yerr=Group1["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
	caplines1[0].set_marker('_')
	caplines1[0].set_markersize(3)
	plt.title("Distance moved by Hour", fontsize=20)
	plt.xlabel("Hour", fontsize=16)
	plt.ylabel("distance moved (cm)", fontsize=16)
	...
	plt.savefig(directory0 + "Graphs/TotPathlength" + today + ".jpg")
	plt.show()
...
if (numberofgroups == 2):
	...
	if (value == 1):
		...
		Group1 = pd.read_csv(maindirectory + "Temp/" + treatment1 + "distancemoved.csv")
		Group2 = pd.read_csv(maindirectory + "Temp/" + treatment2 + "distancemoved.csv")
		...
		plt.plot(Group2["Hour"], Group2["TotPathlength"], Color=Color2, marker=",", linestyle="-")
		plotline2, caplines2, line2 = plt.errorbar(Group2["Hour"], Group2["TotPathlength"], yerr=Group2["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 3):
	...
	if (value == 1):
		...
		Group1 = pd.read_csv(maindirectory + "Temp/" + treatment1 + "distancemoved.csv")
		Group2 = pd.read_csv(maindirectory + "Temp/" + treatment2 + "distancemoved.csv")
		Group3 = pd.read_csv(maindirectory + "Temp/" + treatment3 + "distancemoved.csv")
		...
		plt.plot(Group3["Hour"], Group3["TotPathlength"], Color=Color3, marker=",", linestyle="-")
		plotline3, caplines3, line3 = plt.errorbar(Group3["Hour"], Group3["TotPathlength"], yerr=Group3["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 4):
	...
	if (value == 1):
		...
		Group2 = pd.read_csv(maindirectory + "Temp/" + treatment2 + "distancemoved.csv")
		Group3 = pd.read_csv(maindirectory + "Temp/" + treatment3 + "distancemoved.csv")
		Group4 = pd.read_csv(maindirectory + "Temp/" + treatment4 + "distancemoved.csv")
		...
		plt.plot(Group4["Hour"], Group4["TotPathlength"], Color=Color4, marker=",", linestyle="-")
		plotline4, caplines4, line4 = plt.errorbar(Group4["Hour"], Group4["TotPathlength"], yerr=Group4["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 5):
	...
	if (value == 1):
		...
		Group3 = pd.read_csv(maindirectory + "Temp/" + treatment3 + "distancemoved.csv")
		Group4 = pd.read_csv(maindirectory + "Temp/" + treatment4 + "distancemoved.csv")
		Group5 = pd.read_csv(maindirectory + "Temp/" + treatment5 + "distancemoved.csv")
		...
		plt.plot(Group5["Hour"], Group5["TotPathlength"], Color=Color5, marker=",", linestyle="-")
		plotline5, caplines5, line5 = plt.errorbar(Group5["Hour"], Group5["TotPathlength"], yerr=Group5["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 6):
	...
	if (value == 1):
		...
		Group4 = pd.read_csv(maindirectory + "Temp/" + treatment4 + "distancemoved.csv")
		Group5 = pd.read_csv(maindirectory + "Temp/" + treatment5 + "distancemoved.csv")
		Group6 = pd.read_csv(maindirectory + "Temp/" + treatment6 + "distancemoved.csv")
		
		plt.bar(Group1["Treatment"], Group1["TotPathlength"], Color=Color1, marker=",", linestyle="-")
		plotline1, caplines1, line1 = plt.errorbar(Group1["Hour"], Group1["TotPathlength"], yerr=Group1["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
		caplines1[0].set_marker('_')
		caplines1[0].set_markersize(3)
		
		plt.bar(Group2["Treatment"], Group2["TotPathlength"], Color=Color2, marker=",", linestyle="-")
		plotline2, caplines2, line2 = plt.errorbar(Group2["Hour"], Group2["TotPathlength"], yerr=Group2["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
		caplines2[0].set_marker('_')
		caplines2[0].set_markersize(3)
		
		plt.bar(Group3["Treatment"], Color=Color3, marker=",", linestyle="-")
		plotline3, caplines3, line3 = plt.errorbar(Group3["Hour"], Group3["TotPathlength"], yerr=Group3["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
		caplines3[0].set_marker('_')
		caplines3[0].set_markersize(3)
		
		plt.bar(Group4["Treatment"], Group4["TotPathlength"], Color=Color4, marker=",", linestyle="-")
		plotline4, caplines4, line4 = plt.errorbar(Group4["Hour"], Group4["TotPathlength"], yerr=Group4["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
		caplines4[0].set_marker('_')
		caplines4[0].set_markersize(3)
		
		plt.bar(Group5["Treatment"], Group5["TotPathlength"], Color=Color5, marker=",", linestyle="-")
		plotline5, caplines5, line5 = plt.errorbar(Group5["Hour"], Group5["TotPathlength"], yerr=Group5["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
		caplines5[0].set_marker('_')
		caplines5[0].set_markersize(3)
		
		plt.bar(Group6["Treatment"], Group6["TotPathlength"], Color=Color6, marker=",", linestyle="-")
		plotline6, caplines6, line6 = plt.errorbar(Group6["Hour"], Group6["TotPathlength"], yerr=Group6["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 7):
	...
	if (value == 1):
		...
		Group5 = pd.read_csv(maindirectory + "Temp/" + treatment5 + "distancemoved.csv")
		Group6 = pd.read_csv(maindirectory + "Temp/" + treatment6 + "distancemoved.csv")
		Group7 = pd.read_csv(maindirectory + "Temp/" + treatment7 + "distancemoved.csv")
		...
		plt.plot(Group6["Hour"], Group6["TotPathlength"], Color=Color6, marker=",", linestyle="-")
		plotline6, caplines6, line6 = plt.errorbar(Group6["Hour"], Group6["TotPathlength"], yerr=Group6["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
		caplines6[0].set_marker('_')
		caplines6[0].set_markersize(3)
		
		plt.plot(Group7["Hour"], Group7["TotPathlength"], Color=Color7, marker=",", linestyle="-")
		plotline7, caplines7, line7 = plt.errorbar(Group7["Hour"], Group7["TotPathlength"], yerr=Group7["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 8):
	...
	if (value == 1):
		...
		Group6 = pd.read_csv(maindirectory + "Temp/" + treatment6 + "distancemoved.csv")
		Group7 = pd.read_csv(maindirectory + "Temp/" + treatment7 + "distancemoved.csv")
		Group8 = pd.read_csv(maindirectory + "Temp/" + treatment8 + "distancemoved.csv")
		...
		plt.plot(Group8["Hour"], Group8["TotPathlength"], Color=Color8, marker=",", linestyle="-")
		plotline8, caplines8, line8 = plt.errorbar(Group8["Hour"], Group8["TotPathlength"], yerr=Group8["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 9):
	...
	if (value == 1):
		...
		Group7 = pd.read_csv(maindirectory + "Temp/" + treatment7 + "distancemoved.csv")
		Group8 = pd.read_csv(maindirectory + "Temp/" + treatment8 + "distancemoved.csv")
		Group9 = pd.read_csv(maindirectory + "Temp/" + treatment9 + "distancemoved.csv")
		...
		plt.plot(Group9["Hour"], Group9["TotPathlength"], Color=Color9, marker=",", linestyle="-")
		plotline9, caplines9, line9 = plt.errorbar(Group9["Hour"], Group9["TotPathlength"], yerr=Group9["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 10):
	...
	if (value == 1):
		...
		Group8 = pd.read_csv(maindirectory + "Temp/" + treatment8 + "distancemoved.csv")
		Group9 = pd.read_csv(maindirectory + "Temp/" + treatment9 + "distancemoved.csv")
		Group10 = pd.read_csv(maindirectory + "Temp/" + treatment10 + "distancemoved.csv")
		...
		plt.plot(Group10["Hour"], Group10["TotPathlength"], Color=Color10, marker=",", linestyle="-")
		plotline10, caplines10, line10 = plt.errorbar(Group10["Hour"], Group10["TotPathlength"], yerr=Group10["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 11):
	...
	if (value == 1):
		...
		Group9 = pd.read_csv(maindirectory + "Temp/" + treatment9 + "distancemoved.csv")
		Group10 = pd.read_csv(maindirectory + "Temp/" + treatment10 + "distancemoved.csv")
		Group11 = pd.read_csv(maindirectory + "Temp/" + treatment11 + "distancemoved.csv")
		...
		plt.plot(Group11["Hour"], Group11["TotPathlength"], Color=Color11, marker=",", linestyle="-")
		plotline11, caplines11, line11 = plt.errorbar(Group11["Hour"], Group11["TotPathlength"], yerr=Group11["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
...
if (numberofgroups == 12):
	...
	if (value == 1):
		...
		Group10 = pd.read_csv(maindirectory + "Temp/" + treatment10 + "distancemoved.csv")
		Group11 = pd.read_csv(maindirectory + "Temp/" + treatment11 + "distancemoved.csv")
		Group12 = pd.read_csv(maindirectory + "Temp/" + treatment12 + "distancemoved.csv")
		...
		plt.plot(Group12["Hour"], Group12["TotPathlength"], Color=Color12, marker=",", linestyle="-")
		plotline12, caplines12, line12 = plt.errorbar(Group12["Hour"], Group12["TotPathlength"], yerr=Group12["Error"],  fmt='none', ecolor="black", elinewidth=1, capsize=1, lolims=True)
