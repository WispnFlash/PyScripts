...
if (numberofgroups == 1):
	...
	directory1 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment1 + "/"
	...
	plt.title("Initial Discrimination - Entries to 80% criterion scatterplot")
...
if (numberofgroups == 2):
	...
	directory1 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment1 + "/"
	directory2 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment2 + "/"
	Group1 = CreateCohort(directory1)
	Group2 = CreateCohort(directory2)
	groups = pd.concat([Group1, Group2], axis=0)
	groups.to_csv(directory0 + "IDETCforallgroups.csv")
	n1 = str(len(os.listdir(directory1)))
...
if (numberofgroups == 3):
	...
	directory1 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment1 + "/"
	directory2 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment2 + "/"
	directory3 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment3 + "/"
	Group1 = CreateCohort(directory1)
	Group2 = CreateCohort(directory2)
...
if (numberofgroups == 4):
	...
	directory2 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment2 + "/"
	directory3 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment3 + "/"
	directory4 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment4 + "/"
	Group1 = CreateCohort(directory1)
	Group2 = CreateCohort(directory2)
	Group3 = CreateCohort(directory3)
...
if (numberofgroups == 5):
	...
	directory3 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment3 + "/"
	directory4 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment4 + "/"
	directory5 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment5 + "/"
	Group1 = CreateCohort(directory1)
	Group2 = CreateCohort(directory2)
	Group3 = CreateCohort(directory3)
	Group4 = CreateCohort(directory4)
...
if (numberofgroups == 6):
	...
	directory4 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment4 + "/"
	directory5 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment5 + "/"
	directory6 = directory0 + "Data/Entries to Criterion/Initial Discrimination/" + treatment6 + "/"
	Group1 = CreateCohort(directory1)
	Group2 = CreateCohort(directory2)
	Group3 = CreateCohort(directory3)
	Group4 = CreateCohort(directory4)
